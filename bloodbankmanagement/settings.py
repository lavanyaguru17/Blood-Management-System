...
DATABASES = {
    'default': {
        ...
        'NAME': 'bloodbank_management_system',
        'USER': 'root',
        'PASSWORD': 'mysql.LAV2',
        'HOST': '127.0.0.1',
        'PORT': '3306',
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'lavanyalavanya07158@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'cpek cogh xnir liln' # host email password required
